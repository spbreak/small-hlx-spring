...
public abstract class AbstractApplicationContext extends DefaultResourceLoader implements ConfigurableApplicationContext {
    ...
    @Override
    public void refreash() throws BeansException {
        ...
        // 4. BeanPostPorcessor 需要提前于其他 Bean 对象实例化之前执行注册操作
    ...
    protected abstract void refreashBeanFactory() throws BeansException;

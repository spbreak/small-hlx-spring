...
import cn.hlx.springframework.aop.ClassFilter;
...
import cn.hlx.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
import cn.hlx.springframework.test.bean.UserServiceBeforeAdvice;
...
public class ApiTest {
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* cn.hlx.springframework.test.bean.IUserService.*(..))");
